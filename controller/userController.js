...
import { getUserAppointments } from "./appointmentController.js";


export const patientRegister = catchAsyncErrors(async (req, res, next) => {
  const { firstName, lastName, email, phone,ins, dob, gender, password } =
    req.body;
  if (
    !firstName ||
    !lastName ||
  ...
  try {
    ...
    if (user.role === "patient") {
      ...
      profileData = {
        ...
        // Add additional patient-specific fields here
      };
    }
